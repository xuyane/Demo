...
(function () {
  /**
     ...
     */
  window.UEDITOR_HOME_URL = '/static/UE/UE/'
  ...
  window.UEDITOR_CONFIG = {
    ...
    serverUrl: 'https://mgt.oilchem.net/information/informationtemplate/ueditorUpload',
    ...
    whitList: {
      ...
      section: [],
      small: [],
      span: ['class', 'style', 'data-id', 'data-min', 'data-max'],
      sub: ['class', 'style'],
      sup: ['class', 'style'],
      strong: ['class', 'style'],
      table: ['width', 'border', 'align', 'valign', 'class', 'style'],
      tbody: ['align', 'valign', 'class', 'style'],
      td: ['width', 'rowspan', 'colspan', 'align', 'valign', 'class', 'style', 'id', 'data-id'],
