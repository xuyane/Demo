                  ...
                  <div>
                    <Row offset='20'>
                      ...
                      <Col span="10" offset='2'>
                          <div class='bg-right'>
                          <div class="proinfor">
                            <div class='thisdata' style='display:none'><span v-for='(item,index) in timesolt' :key='index' :class="index==thisdatanum? 'thisdataactive' : ''"   @click="thisdatachange(index)" >{{item.name}}</span></div>
                            <div   >
                              <div class="Onshelf">
                    ...
                    <div class=" financesum">
                      <div class="sum">
                        <Row>
                          ...
                          <Col span="6" class="financeexplain">
                            <div class=""><span>会议金额：<span class="blueword">{{WorkbenchFinancialItemVO.totalConfAmount}}</span></span></div>
                            <div><span>续入金额：<span class="blueword">{{WorkbenchFinancialItemVO.totalOldAmount}}</span></span></div>
                          </Col>
                          <Col span="6" class="financeexplain">
                            <div class=""><span>开票总金额：<span class="blueword">{{WorkbenchFinancialItemVO.invoiceTotalAmount}}</span></span></div>
                            <div><span>退票总金额：<span class="blueword">{{WorkbenchFinancialItemVO.invoiceRefundTotalAmount}}</span></span></div>
                            <div><span>客户数：<span class="blueword">{{WorkbenchFinancialItemVO.memberNum}}</span></span></div>
                          </Col>
                        </Row>
                      </div>
                    </div>
