...
<template>
  <Row>
    ...
    <tab-header :tab-index="10"></tab-header>
...
export default {
  ...
  methods: {
    ...
    getListPage () {
      ...
      let competitorTimeS = formatStamp(this.serviceTime[0])
      let competitorTimeE = formatStamp(this.serviceTime[1])+24*60*60*1000-1000
      ...
      let params = {
        ...
        competitorTimeE:competitorTimeE || '',
