    ...
    <Col span="24">
     ...
     <Col span="24" class="plant-content">
        ...
        <Row>
            ...
            <Col span="24" class="height-50"><Button type="primary" class="margin-y20px" @click="addInfomation">新增信息单元</Button></Col>
            <Col span="24">
     ...
     <Modal v-model="createInfromation" title="新增信息单元" width="600px" @on-cancel="deleteAddInformation">
        <Form ref="createInfromationModel" :model="createInfromationModel" :label-width="120">
            <Row >
                <Col span="24">
                  <FormItem label="序号 ：">
                   <Input v-model="createInfromationModel.sortNumber" class="search-input" placeholder="请选择信息单元" style="width: 300px" ></Input>
        ...
        <div slot="footer">
            <i-button type="primary" @click="saveRelationInfromation">保存</i-button>
...
import informationUnit from "../unitmangement/addInformationUnit";
import {
