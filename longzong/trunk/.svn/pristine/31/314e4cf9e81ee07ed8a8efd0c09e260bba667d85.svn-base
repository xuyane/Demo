    ...
    <Col span="24" class-name="search-form">
      <Form :model="formItem" :label-width="100">
        <Row type="flex" justify="space-between">
          ...
          <!-- <Col span="7">
            <FormItem label="联系电话:">
              <Input v-model="formItem.admin" class="search-input" placeholder="请输入联系电话"></Input>
            </FormItem>
          </Col> -->
...
import { getAutoMergeList } from '../../../components/axios/crm.js';
...
export default {
    ...
    return {
      ...
      columns: [
        ...
        // },
        {
          ...
          minWidth: 120,
          render: (h, data) => {
            let text = '('+data.row.matchNum+')'+data.row.targetName+'...';
  ...
  methods: {
    ...
    getListPage(params) {
      let that = this;
      this.$Spin.show();
      getAutoMergeList(formData(params)).then(resp => {
        that.$Spin.hide();
