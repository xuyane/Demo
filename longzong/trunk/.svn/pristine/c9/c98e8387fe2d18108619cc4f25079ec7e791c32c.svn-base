...
<template >
  <Row class='informationsortbox'>
      ...
      <Card style="margin-bottom:20px">
        <div class="topform">
          <Form ref="formCustom" :model="formCustom" :rules="ruleCustom" :label-width="80">
            <Row>
              <Col span='8'>
              <FormItem label="信息分类名称:" prop="msgname" :label-width="120">
              ...
              <Col span='8'>
              <FormItem label="登录:" prop="online">
                <Select v-model="formCustom.online">
              ...
              <Col span='8'>
              <FormItem label="授权:" prop="authority" :label-width="120">
                <Select v-model="formCustom.authority">
                  <Option value="全部">全部</Option>
                  <Option value="需要">需要</Option>
                  <Option value="不需要">不需要</Option>
                </Select>
              ...
              <Col span='8'>
              <FormItem label="公共信息:" prop="commonmsg">
                <Select v-model="formCustom.commonmsg">
                  <Option value="全部">全部</Option>
    ...
    <add-information-modal :showAddModal='showAddModal' @hide-modal="hideAddModal"></add-information-modal>  
    <check-information-modal :showCheckModal='showCheckModal' @hide-modal="hideCheckModal"></check-information-modal>
    <edit-information-modal :showEditModal='showEditModal' @hide-modal="hideEditModal"></edit-information-modal>
...
<script>
import AddInformationModal from "./addinformation.vue";
import CheckInformationModal from "./checkinformation.vue";
import EditInformationModal from "./editinformation.vue";
import oilPage from "../../components/page/page.vue";
import status from "../components/statusSelect.vue";
export default {
  ...
  methods: {
    ...
    changeno(data) {
      ...
      this.issure.label = "是否确认要禁用该信息分类?";
      this.issure.value = "Y";
    ...
    changeyes(data) {
      console.log(data);
      this.issure.label = "是否确认要启用该信息分类?";
      this.issure.value = "N";
      this.issure.number = data.index;
      console.log(this.issure);
      this.modal1 = true;
