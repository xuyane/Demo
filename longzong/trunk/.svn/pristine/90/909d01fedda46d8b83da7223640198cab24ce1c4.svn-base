...
export default {
        ...
        },
        {
          ...
          render: (h, data) => {
            ...
            return h(
              "span",
              {},
              this.getNameContractStatus(data.row.auditStatus)
            );
          }
        },
        {
        ...
        },
        {
          ...
          render: (h, data) => {
            return h(
              ...
              {
                style: {
                  color: data.row.auditStatus == 1 ? "#515a6e" : "red"
                }
              },
              data.row.auditStatus == 1
                ? "已通过"
                : "驳回，原因：" + data.row.rejectionReason
            );
          }
        }
      ],
  ...
  methods: {
    ...
    showRejectModalconfirm() {
      ...
      params.append("rejectionReason", this.rejectvalue);
      contractretentionrecordUpdate(params).then(resp => {
