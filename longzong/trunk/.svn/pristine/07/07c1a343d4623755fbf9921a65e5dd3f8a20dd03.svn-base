                ...
                <Form ref="basicform" :model="formItem" style="margin-top: 20px;"> 
                    <Row >
                        ...
                        <FormItem label="发布时间:" :label-width="100">
                            <DatePicker type="daterange" v-model="formItem.publishTime" placement="bottom-end" placeholder="请选择日期" style="width: 200px"></DatePicker>
                        </FormItem>
                        </Col>    
                    </Row>
                    <Row type="flex" justify="space-between">
                        <Col span="24" class="text-right">
                            <Button type="primary" @click="selectPublishList">查询</Button>
                            <Button style="margin-left: 8px" @click="resetPublishList">重置</Button>
                        </Col>
                    </Row>
                </Form>
                <Table :columns="columns4" :data="data4" style="margin-top:20px"></Table>
                <Row>
                    <oil-page
                    :total="totalPublish"
