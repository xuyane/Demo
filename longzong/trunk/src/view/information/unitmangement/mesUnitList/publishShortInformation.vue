                ...
                <Form ref="basicform" :model="formItemShort" style="margin-top: 20px;"> 
                    <Row >
                        ...
                        <FormItem label="发布时间:" :label-width="100">
                            <DatePicker type="daterange" v-model="formItemShort.publishTime" placement="bottom-end" placeholder="请选择日期" style="width: 200px"></DatePicker>
                        </FormItem>
                        </Col>    
                        <Col span="6" class="text-right">
                            <Button type="primary" @click="SelectShortList">查询</Button>
