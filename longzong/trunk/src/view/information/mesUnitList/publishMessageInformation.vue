    ...
    <Modal v-model="publishedMessageModal" title="已发布信息" width="950" @on-cancel="messageCancel"> 
            ...
            <div class="unit" >
                ...
                <Form ref="formItemMessage" :model="formItemMessage" style="margin-top: 20px;"> 
                    <Row >
                        <Col span="6"><FormItem label="短信内容: "  :label-width="80"><Input v-model="formItemMessage.content" type="text" /></FormItem></Col>
                        <Col span="6">
                        ...
                        <FormItem label="发布时间 ：" :label-width="100">
                            <DatePicker type="daterange" v-model="formItemMessage.publishTime" placement="bottom-end" placeholder="Select date" style="width: 200px" disabled></DatePicker>
                        </FormItem>
                        </Col>    
                        <Col span="6" class="text-right">
                            <Button type="primary" @click="toMessageList">查询</Button>
...
export default {
    name: "publishMessageInformation",
     props: ["showPublishMessageModal","linkerData"],
    components: {
        oilPage
    },
    data () {
        return {
            ...
            pageSizeOptsMessage: [5, 10, 20, 30],
            loadingEmploy:false,
            options1: [],
        }
    },
