...
<template>
  <Row>
    ...
    <Form ref="form" :model="formItem">
      <Row type="flex" justify="space-between">
        ...
        <FormItem label="部门名称：" :label-width="82">
          <Select v-model="formItem.orgId" class="search-input" filterable placeholder="请输入部门" @on-query-change="getDepartments">
            <Option v-for="item in formItem.departmentList" :value="item.key" :key="item.key">{{ item.value }}</Option>
          </Select>
        </FormItem>
        </Col>
        <Col span="6">
        <FormItem label="时间：" :label-width="100">
          <!-- <Select v-model="formItem.selectYear" class="search-input">
                <Option v-for="item in formItem.timeList" :value="item.value" :key="item.value">{{ item.label }}</Option>
              </Select> -->
        ...
        <FormItem label="业绩类型：" :label-width="120">
          <Select v-model="formItem.type" class="search-input">
            <Option v-for="item in formItem.typeList" :value="item.value" :key="item.value">{{ item.label }}</Option>
          </Select>
        </FormItem>
        </Col>
    ...
    <Table class="tableCommon" :data="tableData" :columns="columns" :stripe="true" :border="true" ref="selection">
    </Table>
...
<script>
  ...
  export default {
    ...
    data() {
      return {
        ...
        formItem: {
          ...
          type: "",
          typeList: [{ value: 1, label: "新入" }, { value: 2, label: "续入" }]
        },
        orgTargetAmountList: {
          janTarget: "",
          febTarget: "",
                          ...
                          if (!data.row.isInput1) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminJanTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminJanTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput2) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminFebTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminFebTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput3) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminMarTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminMarTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput4) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminAprTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminAprTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput5) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminMayTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminMayTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput6) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminJunTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminJunTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput7) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminJulTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminJulTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput8) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminAugTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminAugTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput9) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminSeptTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminSeptTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput10) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminOctTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminOctTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput11) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminNovTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminNovTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
                          ...
                          if (!data.row.isInput12) {
                            return h("div", [
                              h(
                                ...
                                Number(
                                  (
                                    Number(data.row.adminDecTarget) * Number(100)
                                  ).toFixed(2)
                                )
                              )
                            ]);
                            ...
                            return h("div", [
                              h("i-input", {
                                props: {
                                  ...
                                  value: Number(
                                    (
                                      Number(data.row.adminDecTarget) *
                                      Number(100)
                                    ).toFixed(2)
                                  ),
                                  size: "small"
    ...
    created() {
      let data = new Date();
      this.formItem.selectYear = String(data.getFullYear());
      this.changeTab2();
      this.getListAdminSalesMonth();
    ...
    methods: {
      ...
      getListAdminSalesMonth() {
        ...
        listAdminSalesMonth(form).then(res => {
          console.log("6yue",res.response.orgJunTarget)
          ...
          this.tableData.map(item => {
            ...
            let data =
              year + "-" + that.addZero(month) + "-" + that.addZero(date);
            item.entTime = data;
      ...
      getDepeartmentList(name) {
        ...
        pfDeptSelect(form).then(res => {
          this.formItem.departmentList = res.response;
        });
      },
      getDepartments(data) {
        ...
        this.$Modal.confirm({
          ...
          onOk: () => {
            if (this.validateData()) {
              ...
              saveAdminSalesMonth(form).then(res => {
                this.tableData.map(item => {
                  item.isInput1 = false;
                  item.isInput2 = false;
                  item.isInput3 = false;
      ...
      changeAmount(data, e, num) {
        ...
        if (num == 1) {
          this.tableData[data.index].adminJanTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 2) {
          this.tableData[data.index].adminFebTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 3) {
          this.tableData[data.index].adminMarTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 4) {
          this.tableData[data.index].adminAprTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 5) {
          this.tableData[data.index].adminMayTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 6) {
          this.tableData[data.index].adminJunTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 7) {
          this.tableData[data.index].adminJulTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 8) {
          this.tableData[data.index].adminAugTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 9) {
          this.tableData[data.index].adminSeptTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 10) {
          this.tableData[data.index].adminOctTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 11) {
          this.tableData[data.index].adminNovTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        } else if (num == 12) {
          this.tableData[data.index].adminDecTarget = Number(
            (Number(value) / Number(100)).toFixed(4)
          );
        }
      },
      ...
      validateData() {
        ...
        for (let i = 0; i < this.tableData.length; i++) {
          totalJan = Number(
            (totalJan + Number(this.tableData[i].adminJanTarget)).toFixed(2)
          );
          totalFeb = Number(
            (totalFeb + Number(this.tableData[i].adminFebTarget)).toFixed(2)
          );
          totalMar = Number(
            (totalMar + Number(this.tableData[i].adminMarTarget)).toFixed(2)
          );
          totalApr = Number(
            (totalApr + Number(this.tableData[i].adminAprTarget)).toFixed(2)
          );
          totalMay = Number(
            (totalMay + Number(this.tableData[i].adminMayTarget)).toFixed(2)
          );
          totalJun = Number(
            (totalJun + Number(this.tableData[i].adminJunTarget)).toFixed(2)
          );
          totalJul = Number(
            (totalJul + Number(this.tableData[i].adminJulTarget)).toFixed(2)
          );
          totalAug = Number(
            (totalAug + Number(this.tableData[i].adminAugTarget)).toFixed(2)
          );
          totalSept = Number(
            (totalSept + Number(this.tableData[i].adminSeptTarget)).toFixed(2)
          );
          totalOct = Number(
            (totalOct + Number(this.tableData[i].adminOctTarget)).toFixed(2)
          );
          totalNov = Number(
            (totalNov + Number(this.tableData[i].adminNovTarget)).toFixed(2)
          );
          totalDec = Number(
            (totalDec + Number(this.tableData[i].adminDecTarget)).toFixed(2)
          );
        }
        ...
        if (this.indexNum > 1) {
          ...
          if (e.target.checked) {
            if (this.formItem.selectYear > this.nowYear) {
              ...
              this.formItem.selectYear == this.nowYear &&
              this.nowMonth >= num
            ) {
      ...
      rapidDispatch() {
        ...
        let index = false;
        if (
          this.tableData[0].isInput1 ||
          this.tableData[0].isInput2 ||
          this.tableData[0].isInput3 ||
          this.tableData[0].isInput4 ||
          this.tableData[0].isInput5 ||
          this.tableData[0].isInput6 ||
          this.tableData[0].isInput7 ||
          this.tableData[0].isInput8 ||
          this.tableData[0].isInput9 ||
          this.tableData[0].isInput10 ||
          this.tableData[0].isInput11 ||
          this.tableData[0].isInput12
        ) {
          index = true;
        } else {
          index = false;
