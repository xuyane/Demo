...
<script>
  import { listOrgNewSalesMonth, saveOrgNewSalesMonth } from "../../components/axios/performanceManagement.js";
    ...
    methods: {
      ...
      saveData() {
        ...
        if (this.validateData()) {
          ...
          saveOrgNewSalesMonth(form).then(res => {
            this.tableData.map(item => {
              item.isInput1 = false;
              item.isInput2 = false;
              item.isInput3 = false;
            ...
            const arr = new Array(...this.tableData);
            this.tableData = arr;
            // this.$router.push({ name: 'mouthTaskSet' })
