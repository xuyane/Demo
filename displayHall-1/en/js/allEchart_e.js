...
function singleyAxisChartData1(echObj,datas) {
    var line_option_single = {  
        color:datas.colors,
        grid: {
            top: '110px',
...
// 双Y轴echart表
function doubleyAxisChartData1(echObj,datas) {
    var line_option = { 
        color:datas.colors, 
        grid: {
            top: '110px',
...
// Steel-Price 专用
function doubleyAxisBaiChartData1(echObj,datas) {
    var line_option = { 
        color:datas.colors, 
        grid: {
            top: '110px',
